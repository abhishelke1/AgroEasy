...
class RentalsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Reference to the "products/Rentals" node in Firebase
        databaseReference = FirebaseDatabase.getInstance().getReference("products").child("Rentals")
    ...
    private fun fetchProductsFromFirebase() {
        databaseReference.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@RentalsActivity, "Failed to load data: ${error.message}", Toast.LENGTH_SHORT).show()
                Log.e("RentalsActivity", "Database error: ${error.message}")
            }
        })
    }
