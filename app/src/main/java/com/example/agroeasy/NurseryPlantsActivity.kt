...
class NurseryPlantsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Reference to the "products/NurseryPlants" node in Firebase
        databaseReference = FirebaseDatabase.getInstance().getReference("products").child("Nursery Plants")
    ...
    private fun fetchProductsFromFirebase() {
        databaseReference.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@NurseryPlantsActivity, "Failed to load data: ${error.message}", Toast.LENGTH_SHORT).show()
                Log.e("NurseryPlantsActivity", "Database error: ${error.message}")
            }
        })
    }
