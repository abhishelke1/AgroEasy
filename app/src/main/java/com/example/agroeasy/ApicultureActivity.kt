...
class ApicultureActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_apiculture)
        ...
        // Reference to the "products/Apiculture" node in Firebase
        databaseReference = FirebaseDatabase.getInstance().getReference("products").child("Apiculture")
    ...
    private fun fetchProductsFromFirebase() {
        databaseReference.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@ApicultureActivity, "Failed to load data: ${error.message}", Toast.LENGTH_SHORT).show()
                Log.e("ApicultureActivity", "Database error: ${error.message}")
            }
        })
    }
